...
impl GATTServApp {
    ...
    #[inline]
    pub unsafe fn deregister_service(handle: u16, p2pAttrs: *mut *mut GattAttribute) -> bStatus_t {
    ...
    #[inline]
    pub unsafe fn read_char_cfg(connHandle: u16, charCfgTbl: *const gattCharCfg_t) -> u16 {
